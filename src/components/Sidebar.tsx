...
const sidebarItems: SidebarItem[] = [
    ...
    { id: 'create', label: '議論を作成', icon: '✏️', path: '/create-discussion', requiredPermission: 'canCreateDiscussion' },
    { id: 'my-discussions', label: '自分の議論', icon: '👤', path: '/my-discussions', requiredPermission: 'canCreateDiscussion' },
    { id: 'moderation', label: 'モデレーション', icon: '🛡️', path: '/moderation', requiredPermission: 'canModerate' },
