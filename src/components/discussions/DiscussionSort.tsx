...
export interface DiscussionSortOptions {
  field: 'createdAt' | 'updatedAt' | 'lastActivityAt' | 'participantCount' | 'postCount' | 'followersCount';
  direction: 'asc' | 'desc';
}
...
export const DiscussionSort: React.FC<DiscussionSortProps> = ({
  ...
  return (
    <div className="discussion-sort">
      <div className="discussion-sort__label">
        並び順:
      </div>
      ...
      <div className="discussion-sort__controls">
        ...
        >
          <span className="discussion-sort__direction-icon">
            {getDirectionIcon()}
          </span>
          <span className="discussion-sort__direction-text">
            {getDirectionLabel()}
          </span>
        </button>
      </div>
