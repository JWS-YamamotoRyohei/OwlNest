...
type NotificationAction =
  ...
  | { type: 'SET_NOTIFICATIONS'; payload: { items: NotificationListItem[]; hasMore: boolean; nextToken?: string } }
  | { type: 'ADD_NOTIFICATIONS'; payload: { items: NotificationListItem[]; hasMore: boolean; nextToken?: string } }
  | { type: 'UPDATE_NOTIFICATION'; payload: { notificationId: string; updates: Partial<NotificationListItem> } }
...
export const NotificationProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Load notifications
  const loadNotifications = useCallback(async (options?: NotificationQueryOptions, refresh = false) => {
    if (!user) return;
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : '通知の読み込みに失敗しました' });
    } finally {
  ...
  const loadPreferences = useCallback(async () => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : '設定の読み込みに失敗しました' });
    } finally {
  ...
  const markAsUnread = useCallback(async (notificationId: string) => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : '未読マークに失敗しました' });
    } finally {
      dispatch({ type: 'SET_UPDATING', payload: false });
    }
  }, [user, state.unreadCount]);
  ...
  const archive = useCallback(async (notificationId: string) => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : 'アーカイブに失敗しました' });
    } finally {
      dispatch({ type: 'SET_UPDATING', payload: false });
    }
  }, [user]);
  ...
  const unarchive = useCallback(async (notificationId: string) => {
    if (!user) return;
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : 'アーカイブ解除に失敗しました' });
    } finally {
      dispatch({ type: 'SET_UPDATING', payload: false });
    }
  }, [user]);
  ...
  const deleteNotification = useCallback(async (notificationId: string) => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : '通知の削除に失敗しました' });
    } finally {
      dispatch({ type: 'SET_UPDATING', payload: false });
    }
  ...
  // Batch operation
  const batchOperation = useCallback(async (operation: NotificationBatchOperation) => {
    if (!user) return;
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : '一括操作に失敗しました' });
    } finally {
  ...
  const markAllAsRead = useCallback(async () => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : '全て既読にする操作に失敗しました' });
    } finally {
      dispatch({ type: 'SET_UPDATING', payload: false });
    }
  ...
  const clearRead = useCallback(async () => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : '既読通知のクリアに失敗しました' });
    } finally {
      dispatch({ type: 'SET_UPDATING', payload: false });
    }
  }, [user, state.notifications, state.hasMore, state.nextToken]);
  ...
  const updatePreferences = useCallback(async (preferences: Partial<NotificationPreferences>) => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : '設定の更新に失敗しました' });
    } finally {
      dispatch({ type: 'SET_LOADING_PREFERENCES', payload: false });
    }
  }, [user]);
  ...
  const resetPreferences = useCallback(async () => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : '設定のリセットに失敗しました' });
    } finally {
      dispatch({ type: 'SET_LOADING_PREFERENCES', payload: false });
    }
  }, [user]);
  ...
  const subscribeToPush = useCallback(async () => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : 'プッシュ通知の登録に失敗しました' });
    }
  ...
  const unsubscribeFromPush = useCallback(async () => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: error instanceof Error ? error.message : 'プッシュ通知の解除に失敗しました' });
    }
  }, [user, state.preferences]);
