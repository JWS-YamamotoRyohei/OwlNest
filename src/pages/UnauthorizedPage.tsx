  ...
  return (
    <div className="error-page">
      <div className="error-container">
        ...
        <p className="error-message">このページにアクセスするための権限がありません。</p>

        {isAuthenticated && user && (
          <div className="error-details">
            <p>
              現在のユーザー権限: <strong>{user.role}</strong>
            </p>
            <p>より高い権限が必要な場合は、管理者にお問い合わせください。</p>
          </div>
        )}
        ...
        <div className="error-actions">
          ...
          {isAuthenticated ? (
            ...
            <Link to="/login" className="error-button error-button--primary">
              ログイン
            </Link>
          )}
        </div>
